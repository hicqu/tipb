...
type Row struct {
	...
	// start_ts and commit_ts is version of the row itself. If the row is not
	// from TiKV storage directly, e.g. it's a aggregated value, start_ts and
	// commit_ts won't be filled.
	StartTs          *uint64 `protobuf:"varint,3,opt,name=start_ts,json=startTs" json:"start_ts,omitempty"`
	CommitTs         *uint64 `protobuf:"varint,4,opt,name=commit_ts,json=commitTs" json:"commit_ts,omitempty"`
...
func (m *Row) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CommitTs != nil {
		dAtA[i] = 0x20
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.CommitTs))
	}
...
func (m *Row) Size() (n int) {
	...
	if m.CommitTs != nil {
		n += 1 + sovSelect(uint64(*m.CommitTs))
	}
	if m.XXX_unrecognized != nil {
...
var fileDescriptorSelect = []byte{
	...
	,
}
